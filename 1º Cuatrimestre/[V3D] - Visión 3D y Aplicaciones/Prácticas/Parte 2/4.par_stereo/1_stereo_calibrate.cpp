// build/1_stereo_calibrate images/stereo/calibration/ calibration.yml
...
int main(int argc, char *argv[])
{
    ...
    int	flags = 0;
	cv::TermCriteria criteria = cv::TermCriteria(cv::TermCriteria::MAX_ITER + cv::TermCriteria::EPS, 60, 1e-6);
