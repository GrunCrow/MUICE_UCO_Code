...
C = 0; % Constante de fricción viscosa (valor para oscilación subamortiguada)
h = 0.01;

% Condiciones iniciales
theta_0 = 60*(pi/180); % Cambio de ángulo inicial
...
figure(2)
plot(theta_graf, 'b');
title('Evolución del ángulo en función del tiempo (Sin fricción)');
xlabel('Paso');
ylabel('Ángulo (rad)');
grid on;
